 ...
 * Format banner
 */
export function formatBanner(text) {
 ...
 */
export function formatSectionHeader(text) {
 ...
 * Format events table
 */
export function formatEventsTable(events, limit = 10) {
    const table = new Table({
        head: [
            chalk.bold('Time'),
            chalk.bold('Type'),
 ...
 */
export function formatChainOfThought(thoughts, limit = 5) {
    let output = '';
 ...
 */
export function formatProgress(message, done = false) {
    if (done) {
